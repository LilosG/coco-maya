  ...
  collections: {
    blog: collection({
      ...
      schema: {
        ...
        seoTitle: fields.text({ label: 'SEO Title', description: 'Overrides the browser tab title and search result title.', validation: { isRequired: true } }),
        description: fields.text({ label: 'Meta Description', description: 'Shown in search results and social shares.', multiline: true, validation: { isRequired: true } }),
        ...
        image: imageField('blog/image', 'Hero Image', 'Photo shown at the top of the post, on the blog index, and in social link previews.', true),
        imageAlt: fields.text({ label: 'Image Description for Accessibility', description: 'Describe what is visible in the photo for screen readers and search engines.', validation: { isRequired: true } }),
        eventCTA: fields.object(
          {
            title: fields.text({ label: 'CTA Title', description: 'Leave every field in this section blank to skip a custom CTA and use the site default instead.' }),
            subtitle: fields.text({ label: 'CTA Subtitle', multiline: true }),
            ...
            secondaryHref: fields.text({ label: 'Secondary Button Link (optional)' }),
            formLabel: fields.text({ label: 'Inquiry Form Label' }),
            formSubtitle: fields.text({ label: 'Inquiry Form Subtitle (optional)', multiline: true }),
          },
          { label: 'Custom Event CTA (optional)', description: 'Leave this whole section blank to use the default reservation CTA at the end of the post.' },
        ),
        content: fields.mdx({
          label: 'Body Content',
          description: 'The main article body. Supports headings (## for section headings), bold/italic, bullet and numbered lists, and links — including links to other pages on this site.',
        }),
      },
    }),
