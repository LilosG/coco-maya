...
Coco Maya's rooftop sits above India Street in the heart of Little Italy — an open-air glass atrium bar downstairs and an elevated rooftop patio upstairs, both built around a craft cocktail program with a tropical, coastal edge. The [Cocktail Tower](/menu) — four frozen margaritas built around fresh florals — has become the go-to for tables of four or more, and the [rooftop patio](/happy-hour) is walk-in friendly any time of day, no discount window to plan around.
...
Coco Maya doesn't run a discounted happy hour, but the [rooftop patio and cocktail program](/happy-hour) are available all day, every day of Comic-Con week, so there's no window to plan around if you're coming straight from the convention floor.
