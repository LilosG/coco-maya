export const FEATURED_COCKTAILS = [
  ...
  { name: 'Coupe Classic', description: 'Craft cocktail with house-made syrups and fresh juice', image: '/images/cocktail-coupe-foam.jpg', featured: true },
...
export const FEATURED_FOOD = [
  ...
  { name: 'Oysters', description: 'Roasted oysters, grilled bread, citrus', category: 'dinner', image: '/images/food-oysters.jpg' },
] as const;
